...
String.prototype.grammarPolice = function() {
  var stringToChange;
  var stringToTitleCase;
  stringToChange = this.toLowerCase().split(" ");
  stringToTitleCase = "";
 for(var i = 0; i < stringToChange.length; i++) {
   stringToTitleCase += stringToChange[i][0].toUpperCase() + stringToChange[i].slice(1) + ' ';
 }
 return stringToTitleCase.trim();
};
